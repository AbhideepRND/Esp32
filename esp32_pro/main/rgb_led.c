...
ledc_info_t ledc_ch[RGB_LED_CHANNEL_MAX];
...
static void rgb_led_pwm_init(void)
{
	...
	// Configure channels
	for (rgb_ch = 0; rgb_ch < RGB_LED_CHANNEL_MAX; rgb_ch++)
	{
